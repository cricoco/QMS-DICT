        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="ml-auto" style="margin-right: 35px;">
                    ...
                    <a href="{{ route('documents.formats', ['search' => request('search'), 'sort_by' => 'revision_num', 'sort_dir' => 'desc']) }}" class="btn btn-sm btn-info" style="background-color: #45b3e0;"><i class="fa fa-sort-numeric-down" aria-hidden="true"></i></a>
                    <a href="{{ route('documents.formats', ['search' => request('search'), 'sort_by' => 'revision_num', 'sort_dir' => 'asc']) }}" class="btn btn-sm btn-info" style="background-color: #45b3e0;"><i class="fa fa-sort-numeric-up" aria-hidden="true"></i></a>
                </div>
                <br>
