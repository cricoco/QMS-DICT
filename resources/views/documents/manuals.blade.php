            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div
                        ...
                        <div>
                            <a href="{{ route('documents.manuals', ['search' => request('search'), 'sort_by' => 'doc_title', 'sort_dir' => 'asc']) }}"
                                class="btn btn-sm btn-info" style="background-color: #45b3e0;"><i
                                    class="fa fa-sort-alpha-down" aria-hidden="true"></i></a>
                            <a href="{{ route('documents.manuals', ['search' => request('search'), 'sort_by' => 'revision_num', 'sort_dir' => 'asc']) }}"
                                class="btn btn-sm btn-info" style="background-color: #45b3e0;"><i
                                    class="fa fa-sort-numeric-down" aria-hidden="true"></i></a>
                            <a href="{{ route('documents.manuals', ['search' => request('search'), 'sort_by' => 'revision_num', 'sort_dir' => 'desc']) }}"
                                class="btn btn-sm btn-info" style="background-color: #45b3e0;"><i
                                    class="fa fa-sort-numeric-up" aria-hidden="true"></i></a>
                        </div>
                    </div>
                    <br>
                    <div class="card-body" style="height: 100vh; overflow-y: auto;">
                        <a href="#" class="btn btn-success btn-sm" title="Add New Document" data-bs-toggle="modal"
                            ...
                            style="background-color: #45b3e0; border-color: #45b3e0; color: black;"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" style="white-space: wrap;">
                                <thead>
                                    <tr>
                                        <th>
                                            <a href="{{ route('documents.manuals', array_merge(request()->query(), ['sort_by' => 'doc_ref_code', 'sort_dir' => request('sort_dir') == 'asc' ? 'desc' : 'asc'])) }}"
                                        ...
                                        <th>
                                            <a href="{{ route('documents.manuals', array_merge(request()->query(), ['sort_by' => 'doc_title', 'sort_dir' => request('sort_dir') == 'asc' ? 'desc' : 'asc'])) }}"
                                                style="text-decoration: none; color: inherit;">
                                                Document Title
                                        ...
                                        <th style="text-align: center;">
                                            <a href="{{ route('documents.manuals', array_merge(request()->query(), ['sort_by' => 'revision_num', 'sort_dir' => request('sort_dir') == 'asc' ? 'desc' : 'asc'])) }}"
                                                style="text-decoration: none; color: inherit;">
                                                Revision Number
                                        ...
                                        <th style="text-align: center;">
                                            <a href="{{ route('documents.manuals', array_merge(request()->query(), ['sort_by' => 'effectivity_date', 'sort_dir' => request('sort_dir') == 'asc' ? 'desc' : 'asc'])) }}"
                                                style="text-decoration: none; color: inherit;">
                                                Effectivity Date
