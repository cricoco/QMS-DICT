        ...
        <div class="container" width="20px" height="20px" style="background-color: white; padding: 0;">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="summary-tab" data-bs-toggle="tab" data-bs-target="#summary-tab-pane"
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="visionmission-tab" data-bs-toggle="tab"
                        data-bs-target="#visionmission-tab-pane" type="button" role="tab"
                        aria-controls="visionmission-tab-pane" aria-selected="false">Vision & Mission</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="history-tab" data-bs-toggle="tab" data-bs-target="#history-tab-pane"
                        type="button" role="tab" aria-controls="history-tab-pane" aria-selected="false">History
                        Logs</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="summary-tab-pane" role="tabpanel" aria-labelledby="summary-tab"
                    tabindex="0"><br>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-info">
                                    ...
                                    <a href="{{ route('documents.index') }}" class="small-box-footer">Visit <i
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-success">
                                    ...
                                    <a href="{{ route('documents.manuals') }}" class="small-box-footer">Visit <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-warning">
                                    ...
                                    <a href="{{ route('documents.formats') }}" class="small-box-footer">Visit <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-danger">
                                    ...
                                    <a href="{{ route('archives') }}" class="small-box-footer">Visit <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="visionmission-tab-pane" role="tabpanel"
                ...
                <div class="tab-pane fade" id="qualitypolicy-tab-pane" role="tabpanel"
                    aria-labelledby="qualitypolicy-tab" tabindex="0"><br>
                ...
                <div class="tab-pane fade" id="r9basulta-tab-pane" role="tabpanel" aria-labelledby="r9basulta-tab"
                    ...
                    <div class="card-body" style="font-size: 16px;">
                        <ol>
                            <li>
                                To ensure that all Human Resource Systems are in place in terms of Recruitment, Selection
                                and Placement; Learning and Development; Performance Management; and Rewards and Recognition
                                with 100% compliance to the Civil Service Commission’s Program to Institutionalize
                                Meritocracy and Excellence in Human Resource Management (PRIME-HRM);
                            </li>
                            <li>
                                To ensure efficient and effective financial management, disbursements, monitoring and
                                reporting of all statutory/regulatory and legal requirement of government monitoring
                                agencies thru accurate and timely preparation, verification, certification and submission of
                                financial statements and reports to include monthly, quarterly and annual Financial
                                Statements and other related reports shall be done in the prescribed deadlines;
                            </li>
                            <li>
                                To ensure timely preparation and submission of annual budget of the Regional Office are
                                accurate and accomplished within the prescribed period set by the DICT Central Office, the
                                Department of Budget and Management (DBM), and other concerned government agencies. To
                                monitor budget utilization rate at 90%.
                            </li>
                            <li>
                                To maintain complete inventory of property, plant and equipment (PPE) and efficient process
                                of provision of supply in the office and equipment to property custodians.
                            </li>
                            <li>
                                To maintain 90% of the buildings and facilities as well as the 100% of the official vehicles
                                in good condition to provide personnel conducive workspaces and ensure safe travels
                                respectively.
                            </li>
                            <li>
                                To attain at least a very satisfactory customer satisfaction rating from 80% of customers
                                surveyed.
                            </li>
                        </ol>
                    </div>
                    ...
                    <div class="card-body" style="font-size: 16px;">
                        <ol>
                            <li>
                                To deliver the required ICT products and services according to mutually agreed terms and
                                conditions and existing applicable statutory and regulatory requirements; and
                            </li>
