                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" style="white-space: wrap;">
                                <thead>
                                    <tr>
                                        <th>
                                            <a href="{{ route('publicdocuments.index', array_merge(request()->query(), ['sort_by' => 'doc_ref_code', 'sort_dir' => request('sort_dir') == 'asc' ? 'desc' : 'asc'])) }}"
                                        ...
                                        <th>
                                            <a href="{{ route('publicdocuments.index', array_merge(request()->query(), ['sort_by' => 'doc_title', 'sort_dir' => request('sort_dir') == 'asc' ? 'desc' : 'asc'])) }}"
                                                style="text-decoration: none; color: inherit;">
                                                Document Title
                                        ...
                                        <th style="text-align: center;">
                                            <a href="{{ route('publicdocuments.index', array_merge(request()->query(), ['sort_by' => 'revision_num', 'sort_dir' => request('sort_dir') == 'asc' ? 'desc' : 'asc'])) }}"
                                                style="text-decoration: none; color: inherit;">
                                                Revision Number
                                        ...
                                        <th style="text-align: center;">
                                            <a href="{{ route('publicdocuments.index', array_merge(request()->query(), ['sort_by' => 'effectivity_date', 'sort_dir' => request('sort_dir') == 'asc' ? 'desc' : 'asc'])) }}"
                                                style="text-decoration: none; color: inherit;">
                                                Effectivity Date
                                    ...
                                    @foreach ($documents as $item)
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap;">
                                                <a href="javascript:void(0)" id="pubshow-documents"
                                                    data-url="{{ route('publicdocuments.show', $item->id) }}"
                                                    title="View Document" class="btn btn-info btn-sm"
                                                    style="background-color: #a881af; border-color: #a881af;"><i
                                                        class="fa fa-eye" aria-hidden="true"></i></a> <!-- View -->
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '#pubshow-documents', function() {
                ...
                $.get(docURL, function(data) {
                    ...
                    $('#pub-document-iframe').attr('src', "{{ asset('storage/documents/') }}/" +
                        data.file);
