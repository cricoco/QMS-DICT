                                    ...
                                    <!-- @if(in_array($item->doc_type, ['Quality Manual', 'Operations Manual', 'Procedure Manual'])) -->
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap;">
                                                <a href="{{ url('/p/document/' . $item->id) }}" title="View Document" class="btn btn-info btn-sm" style="background-color: #a881af; border-color: #a881af;"><i class="fa fa-eye" aria-hidden="true"></i></a>
